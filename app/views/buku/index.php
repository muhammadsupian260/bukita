        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="btn-group float-right">
                    ...
                    <a href="<?= base_url; ?>/buku/laporan" class="btn float-right btn-xs btn btn-info" target="_blank">Laporan Buku</a>
                    <a href="<?= base_url; ?>/buku/lihatlaporan" class="btn float-right btn-xs btn btn-warning" target="_blank">Lihat Laporan Buku</a>
                </div>
            </div>
            <div class="card-body">
